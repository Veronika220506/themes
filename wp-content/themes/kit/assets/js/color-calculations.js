 ...
 * @return {Object} - this
 */
function _kitColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_kitColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_kitColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_kitColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _kitColor object.
 *
 * @since Kit 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function kitColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _kitColor( backgroundColor, accentHue );
